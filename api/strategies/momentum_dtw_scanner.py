...
# https://medium.datadriveninvestor.com/creating-a-momentum-trading-scanner-with-dynamic-time-warping-2a4e7ceb1e1c
...
if __name__ == '__main__':
    run_momentum_dtw_scanner()



"""
Sample Dynamic Time Warping algorithm:
